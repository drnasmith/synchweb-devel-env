...
--
-- Host: cs04r-sc-vserv-88    Database: ispyb
-- ------------------------------------------------------
-- Server version	5.5.5-10.0.16-MariaDB-wsrep
...
) ENGINE=InnoDB AUTO_INCREMENT=44227 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43873 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3306149 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=76609 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=44221 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=131462 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11154 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22403 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10613 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `DataCollection` (
  ...
  `EXPERIMENTTYPE` varchar(4000) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=158915 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=158914 DEFAULT CHARSET=latin1 COMMENT='a dataCollectionGroup is a group of dataCollection for a spe';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `DewarLocation` (
  ...
  PRIMARY KEY (`eventId`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=latin1 COMMENT='ISPyB Dewar location table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='List of locations for dewars';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15337 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `EMMovie`
--

DROP TABLE IF EXISTS `EMMovie`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `EMMovie` (
  `emMovieId` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `blsessionId` int(11) unsigned NOT NULL,
  `blsampleId` int(11) unsigned NOT NULL,
  `emmicroscopeId` int(11) unsigned NOT NULL,
  `movieFile` varchar(255) DEFAULT NULL,
  `micrographFullPath` varchar(255) DEFAULT NULL,
  `powerSpectrumFullPath1` varchar(255) DEFAULT NULL,
  `powerSpectrumFullPath2` varchar(255) DEFAULT NULL,
  `driftFullPath` varchar(255) DEFAULT NULL,
  `NOImages` smallint(5) unsigned DEFAULT '0',
  `frameLength` float DEFAULT NULL COMMENT 'Unit: s',
  `totalExposure` float DEFAULT NULL COMMENT 'Unit: s',
  `magnification` float DEFAULT NULL COMMENT 'Unit: X',
  `samplePixSize` float DEFAULT NULL COMMENT 'Unit: A/pix',
  `dosePerFrame` float DEFAULT NULL COMMENT 'Unit: e-/A^2',
  `totalDose` float DEFAULT NULL COMMENT 'Unit: e-/A^2',
  `runStatus` varchar(15) DEFAULT 'Not started',
  `comments` varchar(255) DEFAULT NULL,
  `runDirectory` varchar(255) DEFAULT NULL,
  `binning` tinyint(4) DEFAULT '1' COMMENT '1 or 2. Number of pixels to process as 1. (Use mean value.)',
  `particleDiameter` float DEFAULT NULL COMMENT 'Unit: nm',
  `pixelSize` float DEFAULT NULL,
  `boxSize` float DEFAULT NULL,
  `minResolution` float DEFAULT NULL COMMENT 'Unit: A',
  `maxResolution` float DEFAULT NULL COMMENT 'Unit: A',
  ...
  `extractSize` float DEFAULT NULL COMMENT 'Unit: nm',
  `bgRadius` float DEFAULT NULL COMMENT 'Unit: nm',
  `starttime` datetime DEFAULT NULL,
  `endtime` datetime DEFAULT NULL,
  PRIMARY KEY (`emMovieId`),
  KEY `emMovieId_FK1` (`blsessionId`),
  KEY `emMovieId_FK2` (`blsampleId`),
  KEY `emMovieId_FK3` (`emmicroscopeId`),
  CONSTRAINT `emMovieId_FK1` FOREIGN KEY (`blsessionId`) REFERENCES `BLSession` (`sessionId`),
  CONSTRAINT `emMovieId_FK2` FOREIGN KEY (`blsampleId`) REFERENCES `BLSample` (`blSampleId`),
  CONSTRAINT `emMovieId_FK3` FOREIGN KEY (`emmicroscopeId`) REFERENCES `EMMicroscope` (`emMicroscopeId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `EMParticle`
--

DROP TABLE IF EXISTS `EMParticle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `EMParticle` (
  `emParticleId` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `emMovieId` int(11) unsigned NOT NULL,
  `x` float DEFAULT NULL,
  `y` float DEFAULT NULL,
  PRIMARY KEY (`emParticleId`),
  KEY `EMParticle_FK1` (`emMovieId`),
  CONSTRAINT `EMParticle_FK1` FOREIGN KEY (`emMovieId`) REFERENCES `EMMovie` (`emMovieId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Frame` (
  ...
  PRIMARY KEY (`frameId`)
) ENGINE=InnoDB AUTO_INCREMENT=8472 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8261 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6236 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8482 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5712360 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3261912 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='ISPyB autoProcAttachment files values';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8045 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8552 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Model` (
  ...
  PRIMARY KEY (`modelId`)
) ENGINE=InnoDB AUTO_INCREMENT=8563 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8560 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21375 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4167 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Robot actions as reported by GDA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Run` (
  ...
  PRIMARY KEY (`runId`)
) ENGINE=InnoDB AUTO_INCREMENT=6231 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=96033 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=95925 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=95553 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=95853 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=93582 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=51052 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=50586 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=45202 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `TomoDataCollection`
--

DROP TABLE IF EXISTS `TomoDataCollection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TomoDataCollection` (
  `tomoDataCollectionId` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `blsessionId` int(11) unsigned NOT NULL,
  ...
  `runstatus` varchar(25) DEFAULT NULL,
  `filename` varchar(255) DEFAULT NULL,
  `experimentType` varchar(15) DEFAULT NULL,
  `projectionThumbnail1` varchar(255) DEFAULT NULL,
  `projectionThumbnail2` varchar(255) DEFAULT NULL,
  `projectionThumbnail3` varchar(255) DEFAULT NULL,
  `projectionThumbnail4` varchar(255) DEFAULT NULL,
  `projectionThumbnail5` varchar(255) DEFAULT NULL,
  `resolutionInMicrons` float DEFAULT NULL,
  `fieldOfViewMM` float DEFAULT NULL,
  `axisRange` float DEFAULT NULL,
  `numberOfFrames` mediumint(8) unsigned DEFAULT NULL,
  `comments` varchar(255) DEFAULT NULL,
  `recordtimestamp` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`tomoDataCollectionId`),
  KEY `TomoDataCollection_FK1` (`blsessionId`),
  CONSTRAINT `TomoDataCollection_FK1` FOREIGN KEY (`blsessionId`) REFERENCES `BLSession` (`sessionId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `TomoReconstruction`
--

DROP TABLE IF EXISTS `TomoReconstruction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TomoReconstruction` (
  `tomoReconstructionId` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `tomoDataCollectionId` int(11) unsigned NOT NULL,
  `success` tinyint(1) DEFAULT '0',
  `runstatus` varchar(25) DEFAULT NULL,
  `proccessedDir` varchar(255) DEFAULT NULL,
  `jpegFileFullPath1` varchar(255) DEFAULT NULL,
  `jpegFileFullPath2` varchar(255) DEFAULT NULL,
  `jpegFileFullPath3` varchar(255) DEFAULT NULL,
  `jpegFileFullPath4` varchar(255) DEFAULT NULL,
  `jpegFileFullPath5` varchar(255) DEFAULT NULL,
  `histogramImage` varchar(255) DEFAULT NULL,
  `reportFile` varchar(255) DEFAULT NULL,
  `recordtimestamp` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`tomoReconstructionId`),
  KEY `TomoReconstruction_FK1` (`tomoDataCollectionId`),
  CONSTRAINT `TomoReconstruction_FK1` FOREIGN KEY (`tomoDataCollectionId`) REFERENCES `TomoDataCollection` (`tomoDataCollectionId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11801 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `v_run`
--
...
/*!50001 CREATE VIEW `v_run` AS SELECT 
 1 AS `runId`,
 1 AS `run`,
 1 AS `startDate`,
 1 AS `endDate`*/;
...
-- Dump completed on 2015-03-19 15:07:58
